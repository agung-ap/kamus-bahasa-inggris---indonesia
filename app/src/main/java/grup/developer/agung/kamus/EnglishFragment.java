...
public class EnglishFragment extends Fragment implements DictionaryAdapter.OnClickHandler , DictionaryAdapter.OnLongClickHandler {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((MainActivity)getActivity()).getSupportActionBar().setTitle("English - Indonesian");
        setHasOptionsMenu(true);

        isEmptyMessage = (TextView)view.findViewById(R.id.is_empty_message);
        isEmptyMessage.setVisibility(View.GONE);
        //init recycler view
        recyclerView = (RecyclerView)view.findViewById(R.id.english_recycler_view);
    ...
    private void searchVocabulary(Menu menu){
        ...
        searchView.setQueryHint("Search vocab");
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                try {
                    ...
                    if (query.isEmpty()) {
                        dictionaryList = dictionaryHelper.getAllData(true);
                    } else {
                        dictionaryList = dictionaryHelper.getDataByName(query, true);
                    }
    ...
    public void onClick(DictionaryModel position) {
        ...
        intent.putExtra(getString(R.string.isEnglish), true);
    ...
    public void onLongClick(DictionaryModel position) {
        showOptionDialog(position, true);
    ...
    private class LoadDictionary extends AsyncTask  <Void, Void, ArrayList<DictionaryModel>>{
        ...
        protected ArrayList<DictionaryModel> doInBackground(Void... voids) {
            ...
            return dictionaryHelper.getAllData(true);
        }
                ...
                switch (which){
                    ...
                    case 1 :
                        ...
                        builderInner.setPositiveButton("sure", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog,int which) {
                                dictionaryHelper.delete(dictionaryModel.getId(),true);
